...
def build_combined_docx(path: Path) -> None:
    ...
    data = [
        ["[종합지]", "", ""],
        # 실제 파일은 매체명 칸이 세로 병합돼 있어 팀원 행에도 매체명이 반복된다.
        ...
        ["동아일보", "장윤정 차장 010-4200-0048이동훈 010-3580-0036", ""],
        ["[경제지/전문지]", "", ""],
        ...
        ["문화일보", "이용권 차장 010-9132-0051", ""],
        # 데스크 칸에 부장과 차장이 함께 들어 있는 경우
        ["세계일보", "산업부 : 이강은 부장 010-3283-2008 김건호 차장 010-2506-2009", ""],
        # 팀원 줄에 부장이 섞여 있는 경우 + 병합 없이 팀원이 첫 칸부터 시작하는 옛 레이아웃
        ["국민일보", "산업부 : 지호일 부장 010-4369-2010", ""],
        ["권지혜 차장 010-9092-2011모규엽 산업2부장 010-3255-2012", "", ""],
        # 모기업과 이름이 비슷하지만 다른 매체
        ["조선비즈", "산업부 : 최우석 부장 010-1111-2006", ""],
        ["김철수 차장 010-2222-2007", "", ""],
        ["[통신]", "", ""],
        ["연합뉴스", "산업부 : 박용주 부장 010-6342-2001", ""],
        ["조성흠 차장 010-2824-2002임성호 010-6300-2003", "", ""],
        ["연합뉴스TV", "경제부 : 박상돈 부장 010-7588-2004", ""],
        ["최지숙 차장 010-7307-2005", "", ""],
    ]
    ...
    for row_values in [
        ...
        # 국장급 + 산업부장이 한 칸에 함께, 팀원은 직함 없이 이름만
        ["CBS", "이재준 보도국장 010-9111-3001 임진수 산업부장 010-9111-3002"],
        ["CBS", "박성완 010-9111-3003 박희원 010-9111-3004"],
        # 사전에 없는 매체 — 앞 매체(CBS)에 흡수되지 않아야 한다
        ["가나방송", "정철호 부장 010-9111-3005"],
        ["가나방송", "유성훈 차장 010-9111-3006"],
    ]:
        cells = table.add_row().cells
        for idx, value in enumerate(row_values):
            cells[idx].text = value
